configuration = {
    ...
    :app_host                   => "suoc.syr.edu", #override this in your application.yml

    :community_name             => "Syracuse University Outing Club",

    :community_tagline          => "SUOC Rocks!",
    :community_description      => "The Home of Syracuse University Outing Club",
    :support_email              => "ssupport@suoc.syr.edu",
    :meta_description           => 'For people who love the outdoors in the university setting.',
    ...
    :photo                      => {
        :missing_thumb      => '/assets/stoner_thumb.gif',
        :missing_medium     => "/assets/stoner_medium.gif",
        :paperclip_options  => {
            :styles => {
                :thumb => {
                    :geometry => "100x100#",
